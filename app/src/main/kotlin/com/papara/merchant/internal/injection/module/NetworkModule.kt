...
import com.papara.merchant.internal.util.api.ApiKeyInterceptor
import com.papara.merchant.internal.util.api.ErrorHandlingInterceptor
import com.papara.merchant.internal.util.api.RetryAfterInterceptor
...
internal class NetworkModule {
    ...
    @Provides
    @Singleton
    fun providePaparaService(retrofit: Retrofit): PaparaMerchantService {
        return retrofit.create(PaparaMerchantService::class.java)
    }
}
